    ...
    <div className="max-w-2xl mx-auto px-4 py-12 sm:py-16">
      <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8">
        <div className="text-center mb-6 sm:mb-8">
          <Gift className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 text-[#FC6200]" />
        ...
        {!couponCode ? (
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FC6200]"
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              <input
                ...
                className="mt-1 w-5 h-5 text-[#FC6200] border-gray-300 rounded focus:ring-2 focus:ring-[#FC6200] cursor-pointer"
              />
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              ...
              <label htmlFor="acceptTerms" className="cursor-pointer text-sm sm:text-base text-gray-700">
                Aceito os <span 
                  ...
                  className="font-bold text-[#FC6200] hover:text-[#c44c00] underline decoration-2 cursor-pointer"
            ...
            <button
              ...
              className="w-full bg-[#FC6200] text-white py-4 rounded-lg font-semibold hover:bg-[#e05600] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
          ...
          <div className="text-center py-8">
            ...
            <button
              ...
              className="text-[#FC6200] hover:underline"
            >
              Fazer novo cadastro
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
              ...
              <div className="p-4 bg-[#FFF4EC] border-l-4 border-[#FC6200] rounded-r-lg text-[#9E3E00] font-semibold flex items-center gap-3">
            ...
            <button
              ...
              className="mt-6 w-full bg-[#FC6200] text-white py-3 rounded-xl font-semibold hover:bg-[#e05600] transition-colors focus:ring-2 focus:ring-[#FC6200] focus:outline-none"
            >
              Entendi e Aceito
            </button>
          </div>
